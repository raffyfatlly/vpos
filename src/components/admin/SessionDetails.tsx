  ...
  return (
    <div className="flex flex-col w-full gap-4 max-w-full overflow-hidden px-0 sm:px-4">
      ...
      <Tabs defaultValue="inventory" className="w-full">
        <TabsList className="w-full grid grid-cols-3 h-auto gap-16 bg-transparent p-4">
          <TabsTrigger 
            value="inventory" 
            className="data-[state=active]:bg-primary/10 px-8 py-3 text-sm whitespace-nowrap min-w-0 flex-shrink rounded-md hover:bg-muted/50"
          >
            Inventory
          </TabsTrigger>
          <TabsTrigger 
